<?php
	...
	$msg = "
		...
		<title>CM Event Registration Confirmation</title>
		<style>
		...
		<span style='display:none; font-size:1px; color:#ffffff;'>CM Event Registration Confirmation</span>
												  ...
												  <tr>
													<td bgcolor='#906' style='color:#ffffff;' align='left' width='25%' valign='top' colspan='2'>
														<font color='#ffffff' style='font-size:14px; text-align:left; line-height:1.2em;' face='Arial, Helvetica, sans-serif' class='body_text'>
															<strong>CM Event Registration Confirmation</strong>
														</font>
													</td>
												  </tr>
												  <tr>
